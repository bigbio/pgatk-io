 ...
 * 
 * <b>NOTE:</b> Every class implementing the MzReader
 ...
 *
 */
public interface MzReader extends Serializable {
	 ...
	 */
	Spectrum getSpectrumById(String id) throws PgatkIOException;
