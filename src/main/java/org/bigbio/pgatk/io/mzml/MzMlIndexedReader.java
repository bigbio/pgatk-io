...
public class MzMlIndexedReader implements MzReader, MzIterableReader {
    ...
    public Map<String, org.bigbio.pgatk.io.common.IndexElement> getIndexElementForIds() {
        Map<String, org.bigbio.pgatk.io.common.IndexElement> idToIndex =
     ...
     * @return
     */
    private List<org.bigbio.pgatk.io.common.IndexElement> convertIndexElements(List<psidev.psi.tools.xxindex.index.IndexElement> index) {
        List<org.bigbio.pgatk.io.common.IndexElement> convertedIndex =
